        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center py-12">
              <h3 className="text-xl font-semibold mb-4">Module 5: Difficult Conversations</h3>
              <p className="text-muted-foreground mb-6">
                This module is coming soon! It will cover conflict resolution, feedback delivery, and emotional intelligence.
              </p>
