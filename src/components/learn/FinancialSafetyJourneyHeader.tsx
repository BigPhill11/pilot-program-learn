...
interface FinancialSafetyJourneyHeaderProps {
...
const FinancialSafetyJourneyHeader: React.FC<FinancialSafetyJourneyHeaderProps> = ({
  completedLevels,
  totalLevels,
  journeyCompleted,
  totalPointsEarned
  ...
  return (
    <Card className="bg-gradient-to-r from-purple-50 to-indigo-50 border-purple-500/30">
      <CardHeader>
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white/50 rounded-lg p-3 text-center">
              <div className="text-lg font-bold text-indigo-600">{totalPointsEarned}</div>
...
export default FinancialSafetyJourneyHeader;
