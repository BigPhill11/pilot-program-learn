...
const FuturePlanningLevelComponent: React.FC<FuturePlanningLevelProps> = ({
  level,
  isUnlocked,
  isCompleted,
  onComplete,
  ...
  return (
    <Card className={`${isCompleted ? 'border-green-500 bg-green-50/30' : 'border-indigo-500/30'}`}>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
...
export default FuturePlanningLevelComponent;
