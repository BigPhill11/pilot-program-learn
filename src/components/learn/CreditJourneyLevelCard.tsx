...
import { CreditLevel } from '@/data/credit-journey-data';

interface CreditJourneyLevelCardProps {
  level: CreditLevel;
  isUnlocked: boolean;
  isCompleted: boolean;
...
const CreditJourneyLevelCard: React.FC<CreditJourneyLevelCardProps> = ({
  level,
  isUnlocked,
  isCompleted,
  onLevelSelect
...
export default CreditJourneyLevelCard;
