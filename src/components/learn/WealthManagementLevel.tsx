...
import { ArrowLeft, BookOpen, Gamepad2, HelpCircle, CheckCircle2 } from 'lucide-react';
...
const WealthManagementLevel: React.FC<WealthManagementLevelProps> = ({
  ...
  const allActivitiesCompleted = () => {
    const totalActivities = level.flashcards.length + level.miniGames.length + level.quiz.questions.length;
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-sm text-muted-foreground">
              Progress: {completedActivities.size} / {level.flashcards.length + level.miniGames.length + level.quiz.questions.length} activities
            </div>
          </div>
