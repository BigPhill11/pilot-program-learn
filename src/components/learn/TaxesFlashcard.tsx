...
const TaxesFlashcard: React.FC<TaxesFlashcardProps> = ({
  term,
  definition,
  onMastered,
  isMastered = false
        ...
        <Card className="absolute inset-0 backface-hidden border-2 border-primary/20 hover:border-primary/40 transition-colors">
          <CardContent className="flex items-center justify-center h-full p-4">
            <div className="text-center">
              <h3 className="text-xl font-bold text-primary mb-2">{term}</h3>
