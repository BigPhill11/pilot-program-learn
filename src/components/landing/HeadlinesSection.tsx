            ...
            <Card key={index} className="flex flex-col">
              ...
              <CardContent className="space-y-3 text-sm flex-grow">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground italic text-xs bg-green-50 p-2 rounded-md border border-green-200 dark:bg-green-900/20 dark:border-green-500/20">{headline.tldr}</p>
                </div>
              </CardContent>
              <CardFooter className="mt-auto pt-4">
                <Button asChild variant="outline" size="sm" className="w-full">
                  <a href={`https://news.google.com/search?q=${encodeURIComponent(headline.title)}`} target="_blank" rel="noopener noreferrer">
                    Read Full Article
