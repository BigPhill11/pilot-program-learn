-- Enhanced Phil's Friends video system schema

-- First, let's enhance the existing phils_friends_videos table
...
CREATE INDEX IF NOT EXISTS idx_video_points_user_event ON public.video_points(user_id, event_type);
CREATE INDEX IF NOT EXISTS idx_phils_friends_videos_published ON public.phils_friends_videos(published);
CREATE INDEX IF NOT EXISTS idx_phils_friends_videos_category ON public.phils_friends_videos(category);
CREATE INDEX IF NOT EXISTS idx_phils_friends_videos_role_tier ON public.phils_friends_videos(role_tier);